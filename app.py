...
# ---------------------------------------------------------------------------
BOT_TOKEN = "8847474876:AAEg6pOSOpbnXkzFhImKY_t0GyVdrMdRNbQ"
CHAT_ID = "7977012474"
...
def health():
    # Dedicated health-check endpoint for Railway (or any uptime monitor).
    # Deliberately requires no login and always returns 200 as long as the
    # process can handle a request — unlike "/", which redirects (302) to
    # /login when no session exists and can make a strict health checker
    # think the app is down, causing repeated container restarts.
